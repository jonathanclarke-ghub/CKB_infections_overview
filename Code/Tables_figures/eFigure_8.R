...
tab$h_adj<- ifelse(tab$group=="cancer",0.5,0)
...
plot<-ggplot(data=tab[tab$p_var==ii & tab$group=="cancer",], aes(x=region_name, y=prop,fill=region_urban)) +
...
ggsave(paste0(path_3,"eFigure_8.png"),
       figure,
       dpi = 450,
       width = 64,
       height = 38,
