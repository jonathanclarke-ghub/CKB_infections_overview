...
tab<-as.data.frame(cbind(tab[,1:3],gap_1,tab[,8:9],gap_2,tab[,14:16],gap_3,tab[,23]))        # Subcohort
...
header <- data.frame(col_keys   = col_names,
                     title      = rep("Table 2: Sero-prevalence proportion (SE) for infectious pathogens in the subcohort, by sex, area and birth cohort",12),
                     col_head_1 = rep(c(NA,"Sex","","Area","","Birth cohort","","All"),c(1,2,1,2,1,3,1,1)),
                     col_head_2 = c("Pathogen",  
                                    paste0("Male \n(n=",n_male_sub,")"),paste0("Female \n(n=",n_female_sub,")"),NA,
                                    paste0("Rural \n(n=",n_rural_sub,")"),paste0("Urban \n(n=",n_urban_sub,")"),NA,
                                    paste0("< 1950 \n(n=",n_40s_sub,")"),paste0("1950-1959 \n(n=",n_50s_sub,")"),paste0("> 1959 \n(n=",n_60s_sub,")"),NA,
                                    paste0("All \n(n=",n_sub_all,")")))
...
ft<-flextable(tab, col_keys=c(col_names)) %>%
  ...
  width(j=NULL,width=c(rep(c(1.5,1.2,0.1,1.2,0.1,1.2,0.1,1.2),c(1,2,1,2,1,3,1,1)))) %>%
...
save_as_docx(ft,path="K:/kadoorie/Staff_Folders/JonathanC/Projects/serology/Tables_figures/Tables_figures_10/Table_2.docx",
